import {
  ...
  Users, Bell, Wallet, ShieldCheck, PiggyBank, HeartHandshake
} from "lucide-react";
...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { titleKey: "nav.mohorana", url: "/mohorana", icon: HeartHandshake, color: "text-feature-receivables", active: true },
    ],
  },
  {
    labelKey: "nav.wealth",
