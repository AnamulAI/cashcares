      ...
      <div className="mt-5 h-[280px]">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={trendChartData}>
            ...
            <Line type="monotone" dataKey="income" stroke="hsl(var(--positive))" strokeWidth={2.5} dot={false} activeDot={{ r: 4, strokeWidth: 2 }} name="Income" />
            <Line type="monotone" dataKey="expense" stroke="hsl(var(--negative))" strokeWidth={2.5} dot={false} activeDot={{ r: 4, strokeWidth: 2 }} name="Expense" />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
