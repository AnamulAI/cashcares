    ...
    <div className="print-only mt-10">
      ...
      <div className="flex justify-end mb-6">
        <div className="w-64 text-center">
          <div className="border-b border-foreground/70 h-10" />
          <p className="mt-1 text-[10.5px] text-muted-foreground uppercase tracking-wider">
            Authorized by
          </p>
          <p className="text-[11.5px] font-semibold mt-0.5">{signerName}</p>
          {profile?.role_title && (
            <p className="text-[10px] text-muted-foreground">{profile.role_title}</p>
          )}
        </div>
      </div>

      {/* App credit */}
      <div className="pt-3 border-t text-center text-[10px] text-muted-foreground">
