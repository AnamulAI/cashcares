...
export const mockCategories: Category[] = [
  ...
  { id: "c17", name: "Family", group: "expense", icon: "Heart", color: "#e11d48", usageCount: 7, isActive: true, usableInBudgets: true },
  // Savings
...
export const mockTransactions: Transaction[] = [
  { id: "t1", type: "income", categoryId: "c1", categoryName: "Salary", accountId: "a2", accountName: "Dutch Bangla Bank", amount: 75000, date: "2026-03-01", note: "March salary", status: "completed", tags: ["march", "salary"] },
  { id: "t2", type: "expense", categoryId: "c6", categoryName: "Food & Dining", subcategory: "Lunch", accountId: "a1", accountName: "Cash in Hand", amount: 850, date: "2026-03-06", note: "Lunch at office", status: "completed" },
  { id: "t3", type: "expense", categoryId: "c7", categoryName: "Transport", subcategory: "Ride", accountId: "a3", accountName: "bKash Personal", amount: 350, date: "2026-03-06", note: "Uber to office", status: "completed" },
  { id: "t4", type: "income", categoryId: "c2", categoryName: "Freelance", accountId: "a3", accountName: "bKash Personal", amount: 25000, date: "2026-03-04", note: "Website project", status: "completed", tags: ["freelance", "web"] },
  { id: "t5", type: "expense", categoryId: "c8", categoryName: "Bills & Utilities", subcategory: "Internet", accountId: "a2", accountName: "Dutch Bangla Bank", amount: 4500, date: "2026-03-03", note: "Internet bill", status: "completed" },
  ...
  { id: "t9", type: "expense", categoryId: "c14", categoryName: "Household", subcategory: "Groceries", accountId: "a1", accountName: "Cash in Hand", amount: 5500, date: "2026-03-04", note: "Groceries", status: "completed" },
  { id: "t10", type: "income", categoryId: "c3", categoryName: "Business Revenue", accountId: "a6", accountName: "Business Account", amount: 120000, date: "2026-03-01", note: "Client project payment", status: "completed", tags: ["client", "project"] },
  ...
  { id: "t13", type: "expense", categoryId: "c6", categoryName: "Food & Dining", subcategory: "Dinner", accountId: "a1", accountName: "Cash in Hand", amount: 1200, date: "2026-03-05", note: "Dinner with friends", status: "completed" },
  ...
  { id: "t16", type: "expense", categoryId: "c8", categoryName: "Bills & Utilities", subcategory: "Electricity", accountId: "a2", accountName: "Dutch Bangla Bank", amount: 3800, date: "2026-03-01", note: "Electricity bill", status: "completed" },
  ...
  { id: "t18", type: "expense", categoryId: "c7", categoryName: "Transport", subcategory: "CNG", accountId: "a1", accountName: "Cash in Hand", amount: 1500, date: "2026-03-03", note: "CNG fare", status: "completed" },
  ...
  { id: "t20", type: "expense", categoryId: "c6", categoryName: "Food & Dining", subcategory: "Coffee", accountId: "a3", accountName: "bKash Personal", amount: 650, date: "2026-03-06", note: "Coffee shop", status: "completed" },
];
