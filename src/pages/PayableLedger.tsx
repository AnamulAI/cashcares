      ...
      <Dialog open={entryModal} onOpenChange={setEntryModal}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-3 py-1">
            ...
            <div className="grid grid-cols-2 gap-3">
              <CategoryCombobox value={form.category} onChange={v => setForm(f => ({ ...f, category: v }))} entries={entries} group="payable" />
              <div>
            ...
            {editing && <EntryAttachments entryId={editing.id} entryType="payable" />}
          </div>
          <DialogFooter>
